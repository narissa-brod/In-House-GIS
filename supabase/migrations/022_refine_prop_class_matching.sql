-- Refine class matching: case-insensitive, punctuation-insensitive, token AND logic
...
COMMENT ON FUNCTION public.search_parcels IS 'Token-aware class match (case/punctuation-insensitive) + geometry acres fallback + spatial city fallback.';
